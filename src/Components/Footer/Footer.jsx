...
import Call from '../Img/1page/Footer/Call.svg'
import Message from '../Img/1page/Footer/Message.svg'
import Location from '../Img/1page/Footer/Location.svg'
import Payment from '../Img/1page/Footer/payments.svg'
            ...
            <footer className='footer'>
                <div className="container">
                    <div className="footer__info">
                        <ul className='footer__list'>
                            <li className='footer__item'>
                                <img className='footer__logo' src={Logo} alt="Logo" width="125" height="87" />
                            </li>

                            <li className='footer__item1'>
                                <img className='footer__icons' src={Call} alt="Call" width="22" height="22" />
                                <a className='footer__link' href="#link">+38093-717-29-29</a>
                            </li>

                            <li className='footer__item1'>
                                <img className='footer__icons' src={Message} alt="Message" width="20" height="18" />
                                <a className='footer__link' href="#link">kharkivmebelinfo@gmail.com</a>
                            </li>

                            <li className='footer__item1'>
                                <img className='footer__icons' src={Location} alt="Location" width="20" height="26" />
                                <a className='footer__link' href="#link">Харьков</a>
                            </li>
                        ...
                        <ul className='footer__list1'>
                            <li className='footer__item3'>
                                <h6 className='footer__heading'>Наш магазин</h6>
                            </li>

                            <li className='footer__item3'>
                                <a className='footer__link1' href="#link">О магазине</a>
                            </li>

                            <li className='footer__item3'>
                                <a className='footer__link1' href="#link">Наши вакансии</a>
                            </li>

                            <li className='footer__item3'>
                                <a className='footer__link1' href="#link">Контакты</a>
                            </li>

                            <li className='footer__item3'>
                                <a className='footer__link1' href="#link">Мебель в рассрочку</a>
                            </li>

                            <li className='footer__item3'>
                                <a className='footer__link1' href="#link">Бренды</a>
                            </li>

                            <li className='footer__item3'>
                                <a className='footer__link1' href="#link">Возврат товара</a>
                            </li>

                            <li className='footer__item3'>
                                <a className='footer__link1' href="#link">Сертификаты</a>
                            </li>

                            <li className='footer__item3'>
                                <a className='footer__link1' href="#link">Обзоры</a>
                            </li>
                        </ul>

                        <ul className='footer__list2'>
                            <li className='footer__item4'>
                                <h6 className='footer__heading'>Сервис</h6>
                            </li>

                            <li className='footer__item4'>
                                <a className='footer__link1' href="#link">Ваши заказы</a>
                            </li>

                            <li className='footer__item4'>
                                <a className='footer__link1' href="#link">Доставка и оплата</a>
                            </li>

                            <li className='footer__item4'>
                                <a className='footer__link1' href="#link">Сборка мебели</a>
                            </li>

                            <li className='footer__item4'>
                                <a className='footer__link1' href="#link">Хочу в подарок</a>
                            </li>

                            <li className='footer__item4'>
                                <a className='footer__link1' href="#link">Список сравнения</a>
                            </li>

                            <li className='footer__item4'>
                                <a className='footer__link1' href="#link">Карта сайта</a>
                            </li>
                        </ul>

                        <ul className='footer__list3'>
                            <li className='footer__item5'>
                                <h6 className='footer__heading'>Помощь</h6>
                            </li>

                            <li className='footer__item5'>
                                <a className='footer__link1' href="#link">Статьи</a>
                            </li>

                            <li className='footer__item5'>
                                <a className='footer__link1' href="#link">Вопрос ответ</a>
                            </li>

                            <li className='footer__item5'>
                                <a className='footer__link1' href="#link">Производители</a>
                            </li>
                        </ul>

                        <ul className='footer__list4'>
                            <li className='footer__item5'>
                                <h6 className='footer__heading'>Как найти нас ?</h6>
                            </li>

                            <li className='footer__item5'>
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100939.99640951771!2d-122.52000216222986!3d37.75780703852327!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021%3A0x4a501367f076adff!2z0KHQsNC9LdCk0YDQsNC90YbQuNGB0LrQviwg0JrQsNC70LjRhNC-0YDQvdC40Y8sINCh0KjQkA!5e0!3m2!1sru!2s!4v1711822767994!5m2!1sru!2s" width="331" height="229" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="footer__div">
                        <p className='footer__text'>©"Kharkivmebel, 2005 - 2021.</p>
                        <img className='footer__icon1' src={Payment} alt="Payment" width="144" height="24" />
                        <p className='footer__text1'>Created & Powered by</p>
                    </div>
                </div>
            </footer>
        </>
